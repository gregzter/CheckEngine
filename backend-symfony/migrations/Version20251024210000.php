...
final class Version20251024210000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE IF EXISTS obd2_column_variant CASCADE');
        $this->addSql('DROP TABLE IF EXISTS obd2_column CASCADE');
        ...
        // 2. Create OBD2 column mapping tables
        $this->addSql('CREATE TABLE obd2_column (
            id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
            ...
            max_value NUMERIC(10, 4) DEFAULT NULL,
            error_values JSON DEFAULT NULL,
            validation_criteria JSON DEFAULT NULL,
            active BOOLEAN NOT NULL DEFAULT true,
            is_core BOOLEAN NOT NULL DEFAULT false,
            pid_code VARCHAR(10) DEFAULT NULL,
            PRIMARY KEY (id),
            CONSTRAINT unique_obd2_column_name UNIQUE (name)
        )');

        $this->addSql('CREATE TABLE obd2_column_variant (
            id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
            variant_name VARCHAR(255) NOT NULL,
            priority INT NOT NULL DEFAULT 0,
            source VARCHAR(50) NOT NULL DEFAULT \'torque_pro\',
            active BOOLEAN NOT NULL DEFAULT true,
            column_id INT NOT NULL,
            PRIMARY KEY (id)
        )');
        $this->addSql('CREATE INDEX idx_variant_name ON obd2_column_variant (variant_name)');
        $this->addSql('ALTER TABLE obd2_column_variant ADD CONSTRAINT FK_OBD2_VARIANT_COLUMN FOREIGN KEY (column_id) REFERENCES obd2_column (id) ON DELETE CASCADE NOT DEFERRABLE');

        // 3. Create vehicle_model table
        ...
        // 6. Create trip_diagnostic table
        ...
        // 7. Create trip_data table with TimescaleDB hypertable
        ...
        // 8. Convert to TimescaleDB hypertable (7-day chunks)
        $this->addSql("
        ...
        // 9. Enable compression (segment by trip_id for better compression)
        $this->addSql("
        ...
        // 10. Add compression policy (compress after 7 days)
        $this->addSql("
        ...
        // 11. Add retention policy (drop after 1 year)
        $this->addSql("
        ...
        // 12. Insert Toyota Prius+ fixture
        $this->addSql("
