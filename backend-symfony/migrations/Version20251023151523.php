...
final class Version20251023151523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE IF EXISTS vehicles_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE IF EXISTS trips_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE IF EXISTS trip_data_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE IF EXISTS trip_metrics_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE IF EXISTS analysis_history_id_seq CASCADE');
        ...
        $this->addSql('DROP TABLE IF EXISTS analysis_history CASCADE');
        $this->addSql('DROP TABLE IF EXISTS trip_data CASCADE');
        $this->addSql('DROP TABLE IF EXISTS trip_metrics CASCADE');
